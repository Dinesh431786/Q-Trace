...
# Language selection (optional, for multi-language parsing)
...
if st.session_state.get("run_analysis"):
    ...
    if detected:
        st.success(", ".join(str(p) for p in detected))
    else:
